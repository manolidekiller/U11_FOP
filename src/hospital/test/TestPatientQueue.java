...
public class TestPatientQueue {
	...
	public void validateProcessQueue() {
		...
		System.out.println("Ergebnis von ProcessQueue():");
		for (String string : result) {
			System.out.println(string);
		}
		ArrayList<String> expectedList = new ArrayList<String>();
		expectedList.add("T1/Red            -> 10:30 - Mustermann");
		expectedList.add("T1/Red            -> 10:32 - Dwayne TheRock Johnson");
		expectedList.add("T2/Orange-51      -> 14:51 - Salz");
		expectedList.add("T2/Orange-12      -> 23:23 - Max");
		expectedList.add("T3/Green          -> 17:15 - Josef");
